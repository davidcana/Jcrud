...
@JCRUDEntity(storage = OriginalMemberJDBCStorage.class)
@JDBCEntity(table = "original_members")
public class OriginalMember extends Member implements ZCrudEntity {
	...
	public String toString() {
		return "OriginalMember [id=" + id + ", getName()=" + getName() + ", getCountry()=" + getCountry()
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OriginalMember other = (OriginalMember) obj;
		if (id == null) {
			if (other.id != null)
				return false;
